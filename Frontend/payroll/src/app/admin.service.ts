...
export class AdminService {
  ...
  private baseURL = "http://localhost:8093/api/v1/admins";
  empId:any;
  setMessage(data: any)
  {
...
return this.httpClient.get<Admin>(`http://localhost:8093/api/v1/${empId}`);
  }

  updateEmployee(empId: number, admin: Admin): Observable<Object>{
    return this.httpClient.put(`http://localhost:8093/api/v1/${empId}`,admin);
  }

  deleteEmployee(empId: number): Observable<Object>{
    return this.httpClient.delete(`http://localhost:8093/api/v1/${empId}`);
